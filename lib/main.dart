...
class _MainView extends State<MainView> {
  String viewMode = "ListViewImages";//[ListViewImages or GridViewImages or BigImage]

  ListViewImages listViewImages = ListViewImages(title: 'Flutter Demo Home Page');
...
class BigImage extends StatefulWidget {
  const BigImage({Key? key, required this.title}) : super(key: key);
  ...
  @override
  State<BigImage> createState() => _BigImage();
}

class _BigImage extends State<BigImage> {
  int _counter = 0;
